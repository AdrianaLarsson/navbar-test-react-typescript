...
const useStyles = makeStyles({
  ...
  <Box className={classes.root}>
        ...
        >
          ...
          <Tab label={<Typography variant={state === 1 ? "inherit" : "body1"}>Adriana</Typography>}/>
          <Tab  label={<Typography variant={ state === 1 ? "inherit" : "body1"}>Setting</Typography>} />
